...
def loadCircleData(num_data):
    ...
    Mat_Label[0] = center + np.array([-radiu_inner + 7.5, 0])
...
if __name__ == "__main__":
    ...
    unlabel_data_labels = lp.labelPropagation(Mat_Label, Mat_Unlabel, labels, kernel_type = 'knn', knn_num_neighbors = 5, max_iter = 400)
