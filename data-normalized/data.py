...
def naiveStatistic():
    ...
    train_label_table = pd.read_table(train_nolabel_txt,sep='\|\|',index_col=False,header=None,names=['uid','gender','age','area'],engine='python')
...
def train_labelMap():
    ...
    stat_area = '东北,{0}\n华北,{1}\n华东,{2}\n华中,{3}\n华南,{4}\n西南,{5}\n西北,{6}\n境外,{7}' \
        ...
        dicts.values()[4],dicts.values()[5],dicts.values()[6],dicts.values()[7])
